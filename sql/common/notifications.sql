select 
  n.*,
  activities.symbol,
  case when user_has_seen_notification.user_id is null then false else true end as has_seen
...
where s.subscriber=${subscriber} and (n.user_id is null or n.user_id <> ${userId})
